...
const VerificationMsg = () => {
  return (
    <>
      <div className='border border-1 border-[#FFB884] rounded-[7px] p-3 mb-6 bg-[#ffffff]'>
        <div className='flex items-center gap-4'>
          <h1 className='font-semibold text-xl'>Account Verification</h1>
          <span className='text-[12px] font-normal bg-[#FFDDA8] rounded-[50px] px-3 py-1 text-[#FFA922] flex items-center'>
            <GoDotFill className='text-[#FFA922] w-4 h-4 mr-1' /> Pending
          </span>
        </div>
        <p className='mt-3'>
