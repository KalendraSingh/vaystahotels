...
import { updateHotel } from '../../../../api/Vendor/HotelApi';
...
const AddHotel = ({ hotelId }) => {
  ...
  const fetchHotelDetails = async () => {
    try {
      ...
      setFormData(() => ({
        ...
        avgPrice: hotelData.avgPrice || '',
        description: hotelData.description || '',
        cityAddressId: hotelData.cityAddressId || '',
        bannerImage: hotelData.bannerImage || null,
  ...
  const handleSaveAndContinue = async () => {
    ...
    try {
      const res = await updateHotel(formDataToSend, hotelId);
      if (res.status === 200) {
          ...
          <form className='space-y-6'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              >
                ...
                <div className='relative'>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className='pl-10 w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500'
                    placeholder='Enter nearby avgPrice'
                    aria-label='avgPrice'
                  />
                </div>
                {errors.avgPrice && (
              ...
              >
                ...
                <div className='relative'>
                  <Map sendData={sendData} mapData={mapData} />
                </div>
                {errors.location && (
